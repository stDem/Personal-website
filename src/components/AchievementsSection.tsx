...
import agritechnica25 from "@/assets/achievements/agritechnica25.jpeg";
  ...
  const achievements = [
    {
      ...
      items: [
        {
          title: "Participation in AGRITECHNICA 2025",
          description: "Represented Workaholic Robotics at the world's leading trade fair for agricultural technology",
          date: "November 2025",
          detailedDescription: "at AGRITECHNICA 2025 I had a chace to represent Workaholic Robotics — the team that combines precise AI capabilities with advanced engineering to build AI-powered autonomous robots for real-world agricultural and industrial work. With a great team and surrounded by cutting-edge global technologies, the entire week was filled with emotions, new insights, and different people.",
          highlights: ["Agricultural Robotics", "Artificial Intelligence", "Business communication skills"],
          color: "text-blue-600",
          image: agritechnica25
        }
        // {
      ...
      items: [
        {
          ...
          description: "Active advocate and contributor to open source projects",
          date: "Ongoing",
          detailedDescription: "Creating projects with open source code is one of my goal as a developer. To help everyone to reuse my projects, I make sure to write detailed documentation, create examples, and provide support to users.",
          highlights: ["10+ open source projects", "500+ lines of description", "Active community engagement"],
          color: "text-green-600",
          image: openSourceImg
        },
        // {
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-4xl mx-auto mt-12">
          {[
            ...
            { number: "25+", label: "Tecnical Certificates", icon: "⎘" }
          ].map((stat, index) => (
