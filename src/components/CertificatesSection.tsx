      ...
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-6xl mx-auto relative" style={{ height: '2000px' }}>
          ...
          {certificates.map((cert, index) => {
            ...
            const cardSpacing = 600; // Much more spacing between cards
            ...
            const basePosition = Math.max(colorBlockTop - 100, cardsOnSameSide * cardSpacing); // Even more offset
            const topPosition = basePosition + 50; // More margin
