  ...
  return (
    <section id="personal">
      ...
      <div className="relative w-screen bg-white overflow-hidden mb-12 -mx-[50vw] left-1/2" style={{minHeight: '60vh', paddingTop: '5vh', paddingBottom: '5vh'}}>
        ...
        <div className="hero-bg absolute inset-0" style={{backgroundImage: `url('/placeholder.svg')`, backgroundSize: 'contain', backgroundRepeat: 'no-repeat', backgroundPosition: 'center'}}></div>
